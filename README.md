...
- **float perimeter_Kepler()** good and fast algorithm for eccentricity between 1 and 2.
...
Formula is a quadratic approximation of Ramanujan's.
...
- additional functions
  - float ratio() { b / a; };  //  cache as it is nearly constant?
